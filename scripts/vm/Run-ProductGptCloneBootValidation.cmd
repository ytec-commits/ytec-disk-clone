...
set "FIXTURE_OUTPUT=X:\ydc-gpt-clone-fixture.txt"
set "PRODUCT_OUTPUT=X:\ydc-gpt-clone-product.json"

echo === Y-TEC TSUMUGI DRIVE PRODUCT GPT CLONE VM ===
...
"%FIXTURE%" --profile gpt-boot-x64 --authorization YTEC-VM-ONLY-PRODUCT-GPT-BOOT-JOB-FIXTURE >"%FIXTURE_OUTPUT%" 2>&1
...
echo YDCUART=YDC_PRODUCT_GPT_CLONE_PASS;END>COM1
echo.
...
:failure
echo YDCUART=YDC_PRODUCT_GPT_CLONE_FAIL;END>COM1
echo.
echo YDC_PRODUCT_GPT_CLONE_VM_FAIL %FAILURE_DETAIL%
